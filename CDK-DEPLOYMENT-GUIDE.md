...
- **ARN**: `arn:aws:iam::123456789012:policy/CDKMinimalDeployPolicy`
...
- ✅ CloudFront 分发: `EXXXXXXXXXXXXX`
- ✅ 分发域名: `d1234example.cloudfront.net`
...
# 查看 CloudFront 分发
AWS_PROFILE=cdk-deploy aws cloudfront get-distribution --id EXXXXXXXXXXXXX
```
...
# 查看策略详情
AWS_PROFILE=cdk-deploy aws iam get-policy --policy-arn arn:aws:iam::123456789012:policy/CDKMinimalDeployPolicy
```
...
# 分离策略
aws iam detach-user-policy --user-name cdk-deploy-user --policy-arn arn:aws:iam::123456789012:policy/CDKMinimalDeployPolicy

# 删除用户
aws iam delete-user --user-name cdk-deploy-user

# 删除策略
aws iam delete-policy --policy-arn arn:aws:iam::123456789012:policy/CDKMinimalDeployPolicy
```
